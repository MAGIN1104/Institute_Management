...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			...
			<p class="lead">Se podra añadir, modificar y eliminar a estudiantes
			<div class="card">
			<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
										...
										<div class="card-body p-0">
										    <table class="table table-striped">
										        <thead>
										  		...
										  		<tbody>
										  		<?php 
										  		    $estudiante=  ejecutarSQL::consultar("select * from administrador");
										  		    while($admin=mysqli_fetch_array($estudiante)){
										  		        echo '            
										  		        <tr>
