		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Bienvenido (a) <small>Administrador (a)</small></h1>
						...
						<p class="lead">Se podra añadir, modificar y eliminar a profesores</p>
			<div class="card">
			<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
										...
										<div class="card-body p-0">
										    <table class="table table-striped">
										        <thead>
										  		...
										  		<tbody>
										  		<?php 
										  		    $profesor=  ejecutarSQL::consultar("select * from administrador");
										  		    while($admin=mysqli_fetch_array($profesor)){
										  		        echo '            
										  		        <tr>
